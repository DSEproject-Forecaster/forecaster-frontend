    ...
    <div className="summery">
      ...
      <div className="overview">
        <div className="location">
          {" "}
          <MdLocationOn /> Clayton, Victoria
        </div>
        <div className="date-time mt-1">{getDateTime()}</div>
        <div className="temperature mt-1">
          {props.temperature}
          <span>°C</span>
        </div>
        <div className="description mt-1">{props.comment}</div>
      </div>
    </div>
  );
}
